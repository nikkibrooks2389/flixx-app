...
// Utility Functions
const showSpinner = () => document.querySelector('.spinner').classList.add("show");
const hideSpinner = () => document.querySelector('.spinner').classList.remove("show");
    ...
    results.forEach(movie => {
        ...
        div.innerHTML = `
            <a href="movie-details.html?id=${movie.id}">
                ${movie.poster_path ? `<img src="https://image.tmdb.org/t/p/w500${movie.poster_path}" class="card-img-top" alt="${movie.title}">` : `<img src="images/no-image.jpg" class="card-img-top" alt="Movie name">`}
            </a>
            <div class="card-body">
...
//pagination and Search Funtionality
    ...
    results.forEach(result => {
        ...
        div.innerHTML = `
            <a href="${global.search.type}-details.html?id=${result.id}">
                ...
                `<img src="images/no-image.jpg" class="card-img-top" alt="${global.search.type === 'movie' ? 'Movie' : 'Show'} name">`}
            </a>
            <div class="card-body">
